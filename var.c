...
InitVariables()
{
  ...
  var("DISKWIND", DISKWIND, STRING, NO, "NO");
  var("BETACONSTANT", BETACONSTANT, STRING, NO, "NO");
  var("BZCONSTANT", BZCONSTANT, STRING, NO, "NO");
  var("INVBETAPLASMA", &INVBETAPLASMA, REAL, NO, "0.0");
