...
void ApplyLSAOnPotential ()
{
  ...
  /* The expression of the turbulent potential can be found, e.g., at
     Eqs 1 and 2 in BL10. Note that only CPU_Highest randomly sorts rc,
     m, phic and xi */
  ...
  /* CPU_Highest broadcasts information on turbulent parameters to all
     other cpus */
